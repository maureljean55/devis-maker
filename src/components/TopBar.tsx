  ...
  return (
    <header className="no-print bg-app-noir border-b border-gold px-4 md:px-8 py-3 md:py-3.5 flex items-center justify-between sticky top-0 z-50">
      <div className="flex items-center gap-2.5 md:gap-3.5">
        ...
        <img src="/logo.png" alt="Tutto Legno"
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          ...
          title="Déconnexion"
          className="hidden md:block px-3 py-2 text-[11px] font-bold tracking-[1px] uppercase border border-app-border text-app-muted hover:border-red-500 hover:text-red-400 transition-all bg-transparent cursor-pointer"
        >
          ⏻
        </button>
        {/* PDF — desktop uniquement */}
        <button
          onClick={onPrint}
